    ...
    if results.multi_hand_landmarks:
        ...
        #handLMs are 21 points. so we need conection too-->mpHands.HAND_CONNECTIONS
            for id, lm in enumerate(handLms.landmark):
                ...
                cv2.circle(img_w, (cx, cy), 5, (255, 0, 255), cv2.FILLED)
                
            mpDraw.draw_landmarks(img_w, handLms, mpHands.HAND_CONNECTIONS,mp_drawing_styles.get_default_hand_landmarks_style(),
            mp_drawing_styles.get_default_hand_connections_style()) #drawing points and lines(=handconections)
