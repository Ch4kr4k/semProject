  ...
  while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
      for hand_landmarks in results.multi_hand_landmarks:
        ...
        tip_len=distance(float(hand_landmarks.landmark[mp_hands.HandLandmark(7).value].x),float(hand_landmarks.landmark[mp_hands.HandLandmark(7).value].y),float(hand_landmarks.landmark[mp_hands.HandLandmark(0).value].x),float(hand_landmarks.landmark[mp_hands.HandLandmark(0).value].y))
        dip_len=distance(float(hand_landmarks.landmark[mp_hands.HandLandmark(8).value].x),float(hand_landmarks.landmark[mp_hands.HandLandmark(8).value].y),float(hand_landmarks.landmark[mp_hands.HandLandmark(0).value].x),float(hand_landmarks.landmark[mp_hands.HandLandmark(0).value].y))
